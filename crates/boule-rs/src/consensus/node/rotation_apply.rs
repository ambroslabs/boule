//! Commit-time application of [`DualSignedRotation`](crate::consensus::validator_rotation::DualSignedRotation)
...
impl ConsensusNode {
    /// Scan `block.commands` for tagged [`DualSignedRotation`](crate::consensus::validator_rotation::DualSignedRotation)
