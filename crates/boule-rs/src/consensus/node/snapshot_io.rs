...
//!   to the local [`crate::replication::SnapshotStore`] when the
...
impl ConsensusNode {
    ...
    /// Serve a [`crate::consensus::dispatch::Dispatch::ServeSnapshotManifest`]
    ...
    ///
    /// Caller must check
    /// [`crate::replication::snapshot::SnapshotPolicy::should_snapshot_at`]
