...
//!
//! Mirrors [`crate::validator_key_history::ValidatorKeyHistory`]
...
//!   verified upstream (in [`crate::reconfig`]); this
...
impl BlsKeyHistory {
    ...
    /// [`SignerBitmap`](crate::hotstuff::qc::SignerBitmap)
    /// indexes. The returned `Vec<BlsPublicKey>` is suitable for
    /// passing to
    /// [`QuorumCertificate::verify_aggregate_bls`](crate::hotstuff::qc::QuorumCertificate::verify_aggregate_bls).
    ///
    ...
    /// [`crate::validator_key_history::ValidatorKeyHistory::to_persisted`]
...
/// alongside the Ed25519 [`crate::validator_key_history::PersistedValidatorKeyHistory`].
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
...
mod tests {
    ...
    fn pubkeys_for_set_returns_keys_in_validator_order() {
        ...
        let vs = ValidatorSet::new(vec![
            crate::validator_set::ValidatorId::from_genesis_pubkey(nid(2)),
            crate::validator_set::ValidatorId::from_genesis_pubkey(nid(1)),
            crate::validator_set::ValidatorId::from_genesis_pubkey(nid(3)),
        ]);
    ...
    fn pubkeys_for_set_reports_missing_validator() {
        ...
        let vs = ValidatorSet::new(vec![
            crate::validator_set::ValidatorId::from_genesis_pubkey(nid(1)),
            crate::validator_set::ValidatorId::from_genesis_pubkey(nid(99)),
        ]);
    ...
    fn pubkeys_for_set_reports_missing_when_view_predates_registration() {
        ...
        let vs = ValidatorSet::new(vec![
            crate::validator_set::ValidatorId::from_genesis_pubkey(nid(1)),
            crate::validator_set::ValidatorId::from_genesis_pubkey(nid(5)),
        ]);
