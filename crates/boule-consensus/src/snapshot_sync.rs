...
impl SnapshotSync {
    ...
    /// Process a [`crate::dispatch::Dispatch::ReceiveSnapshotManifest`].
    ///
    ...
    /// Process a [`crate::dispatch::Dispatch::ReceiveSnapshotChunk`].
...
mod tests {
    ...
    fn manifest_verify_failure_aborts_with_distinct_reason() {
        ...
        let other_vs = ValidatorSet::new(vec![
            crate::validator_set::ValidatorId::from_genesis_pubkey([10u8; 32]),
            crate::validator_set::ValidatorId::from_genesis_pubkey([11u8; 32]),
            crate::validator_set::ValidatorId::from_genesis_pubkey([12u8; 32]),
            crate::validator_set::ValidatorId::from_genesis_pubkey([13u8; 32]),
        ]);
        let p0 = proposer(&vs, 0);
        let _ = s.observe_proposal(0, 100, p0, &vs);
