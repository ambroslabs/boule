...
mod tests {
    ...
    fn vs(n: u8) -> ValidatorSet {
        ValidatorSet::new(
            (0..n)
                .map(|i| crate::validator_set::ValidatorId::from_genesis_pubkey([i; 32]))
                .collect(),
        )
    }
    ...
    /// [`crate::validator_key_history::ValidatorKeyHistory`]
    ...
    fn verify_rejects_validator_set_mismatch() {
        ...
        let other = ValidatorSet::new(vec![
            crate::validator_set::ValidatorId::from_genesis_pubkey([5u8; 32]),
            crate::validator_set::ValidatorId::from_genesis_pubkey([6u8; 32]),
            crate::validator_set::ValidatorId::from_genesis_pubkey([7u8; 32]),
            crate::validator_set::ValidatorId::from_genesis_pubkey([8u8; 32]),
        ]);
