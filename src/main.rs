...
//! consensus layer.
//!
//! The crate is a binary today: `fn main` in this file boots a node that
//! speaks a TLS-authenticated overlay, gossips messages, and serves an
//! HTTP control API. The layering below consensus is intentionally broken
//! out behind object-safe traits so the eventual consensus state machine
//! can sit on top without rewriting the plumbing.
//!
//! # Layer map
//!
//! ```text
