...
pub enum NodeEvent {
    ...
    /// [`pacemaker::Event::OnTimeout`](crate::consensus::pacemaker::Event::OnTimeout)
    /// to the pacemaker.
    ViewTimerFired(View),
...
#[derive(Debug)]
pub enum Dispatch {
    /// Route to [`HotStuffCore::step`](crate::consensus::hotstuff::HotStuffCore::step).
    Safety(crate::consensus::hotstuff::step::Event),
    /// Route to [`Pacemaker::step`](crate::consensus::pacemaker::Pacemaker::step).
    Pacemaker(crate::consensus::pacemaker::Event),
...
pub enum QcVerification<'a> {
    ...
    Verify {
        ...
        bls_key_history: Option<&'a crate::consensus::bls_key_history::BlsKeyHistory>,
