...
//! re-exported here so the existing `crate::consensus::node::*` paths
//! continue to resolve:
//!
...
//!   middleware that drives [`Action`](crate::consensus::hotstuff::step::Action)
...
//!   [`ReconfigCommand`](crate::consensus::reconfig::ReconfigCommand)
//!   payloads.
//! - `rotation_apply` — commit-time application of
//!   [`DualSignedRotation`](crate::consensus::validator_rotation::DualSignedRotation)
//!   payloads.
...
use crate::consensus::hotstuff::{HotStuffState, QuorumCertificate, genesis_qc};
...
pub struct ConsensusNode {
    ...
    /// [`crate::consensus::limits::CacheLimits::timeout_buckets_capacity`].
    ...
    /// `rate_limiter`, a [`crate::p2p::limits::Decision::Disconnect`]
    /// from the limiter drives a [`crate::p2p::PeerCommand::Disconnect`]
...
impl ConsensusNode {
    ...
    /// returns [`crate::p2p::limits::Decision::Disconnect`] for a peer.
...
mod tests {
    ...
    use crate::consensus::dispatch::Dispatch;
    use crate::consensus::hotstuff::Locked;
    use crate::consensus::hotstuff::qc::TimeoutVote;
    use crate::consensus::hotstuff::step::{Action as SafetyAction, Event as SafetyEvent};
    use crate::consensus::limits::CacheLimits;
    use crate::consensus::validator_set::ValidatorSet;
    use crate::crypto::signed::Signed;
    use crate::p2p::NodeId;
    use crate::p2p::limits::MessageKind;
