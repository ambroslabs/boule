...
use crate::consensus::hotstuff::qc::{TimeoutVote, VerifiedQc};
...
/// core via [`crate::consensus::hotstuff::step::HotStuffCore::with_proposed_in_view`].
...
/// Storage key for the persisted [`crate::consensus::validator_history::ValidatorSetHistory`] (#254).
...
/// Storage key for the persisted [`crate::consensus::validator_key_history::ValidatorKeyHistory`] (#260).
...
/// stall: every leader's [`crate::consensus::hotstuff::step::HotStuffCore::become_leader`] short-circuits
...
impl ConsensusNode {
    ...
    /// so [`crate::consensus::hotstuff::step::HotStuffCore::become_leader`] would silently return an
